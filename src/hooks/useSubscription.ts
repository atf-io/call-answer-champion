...
export const SUBSCRIPTION_PLANS = {
  starter: {
    name: 'Started',
    product_id: 'prod_TwXUnGe8nydpbt',
    price_id: 'price_1SyePtRtSnQCeIF2LJy1fRYb',
    price: 299,
    minutes: 500,
    agents: 1,
  },
  professional: {
    name: 'Growth',
    product_id: 'prod_TwXVX8N4EzbghB',
    price_id: 'price_1SyeQ9RtSnQCeIF2phZXCjKR',
    price: 499,
    minutes: 1500,
    agents: 3,
  },
  enterprise: {
    name: 'Enterprise',
    product_id: 'prod_TwXV6fItMRlxCd',
    price_id: 'price_1SyeQMRtSnQCeIF2Q0E4vxdg',
    price: 899,
    minutes: 5000,
    agents: 10,
  },
